...
def initialize_test_data():
    ...
    test_device2 = db.query(ProductDevice).filter_by(product_id="unique2").first()
    if not test_device2:
        new_device2 = ProductDevice(
            product_id="unique2",
            product_password="securepassword",
        ...
        db.add(new_device2)
        db.commit()
        db.refresh(new_device2)
        print("Second test device added:", new_device2)
